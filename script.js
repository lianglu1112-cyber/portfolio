...
const translations = {
  ...
  jp: {
    ...
    projects: {
      ...
      monica: { title: 'Meet Monica', meta: '映像 / 18分', detailMeta: '映像 / 18分|大学卒業制作', copy: '3人による主創チーム|編集・同期録音・美術' },
      lili: { title: 'LiLi', meta: '映像 / 17分', detailMeta: '映像 / 17分', copy: '7人による主創チーム|プロデューサー / 美術 / 同期録音 / カラーグレーディング' },
